package com.gb.puremvc.model 
{
	...
	/**
	 * Loads the supplied font SWF paths. Fonts must be compiled specifically for Flex.
	 * <p>
	 * Font registration with the parent application is handled within the 
	 * individual font SWFs.</p>
	 */
	public class FlexFontProxy extends AbstractLoaderProxy
	{
		public static const NAME:String = "FlexFontProxy";
		
		/**
		 * Constructor.
		 */
		public function FlexFontProxy(proxyName:String = null, data:Object = null) 
		{
